...
const skillItems = [
  ...
  { icon: <SiReact className="text-cyan-300" />, name: 'React Native' },
  ...
  return (
    <div className="mx-auto max-w-5xl rounded-3xl border border-white/10 bg-slate-950/80 p-8 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl">
      <div className="mb-8 text-center">
        <p className="text-lg uppercase tracking-[0.3em] text-cyan-300">
          Skills
        </p>
        ...
        <p className="mt-3 text-gray-400">
          These are the languages, frameworks, databases, cloud technologies,
          and AI tools I use most frequently in my projects.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {skillItems.map((skill, index) => (
          <div
            key={index}
            className="flex items-center gap-4 rounded-3xl border border-white/10 bg-white/5 px-5 py-4 transition-all duration-300 hover:border-cyan-400 hover:bg-cyan-500/10 hover:scale-105"
          >
